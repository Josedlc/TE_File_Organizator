...
<section class="container-fluid ">
    ...
    <section class="row justify-content-center"> 
        ...
        <form action="iprfmc.php" class="form-container" method= "post" align="center" enctype="multipart/form-data">
    ...
    <option value="4">GRR Variables</option>
                ...
                <div class=" col-3">
                 ...
                 <div class="col-3">
                  <label for="exampleInputEmail1">Revision TE</label>
                  <input type="name" class="form-control" name="revte" id="revte"   placeholder="..." required>
                  </div> 
                ...
                <div class="form-row col-12 ">
                  ...
                  <div class="col-3">
                  <label for="exampleInputEmail1">NP cliente</label>
                  <input type="name" class="form-control" name="npcliente" id="npcliente"   placeholder="..." required>
                  </div>                
                <div class=" col-3">
                  <label for="exampleInputPassword1">Revision cliente</label>
                  <input type="name" class="form-control"  name="revcliente" id="revcliente"  placeholder="..." required>
                  </div>
                  <div class=" col-3">
                  <label for="exampleInputEmail1">St rec estudio 1</label>
                  <input type="name" class="form-control" name="str1" id="str1"   placeholder="..." required>
                </div>

                <div class=" col-3">
                  <label for="exampleInputEmail1">St rec estudio 2</label>
                  <input type="name" class="form-control" name="str2" id="str2"   placeholder="..." required>
                </div>
                ...
                <div class="col-3">
                <label for="exampleInputEmail1">St rec estudio 3</label>
                <input type="name" class="form-control" name="str3" id="str3"   placeholder="..." required>
                </div>                
              <div class=" col-3">
                <label for="exampleInputPassword1">St rec estudio 4</label>
                <input type="name" class="form-control"  name="str4" id="str4"  placeholder="..." required>
                </div>
                <div class=" col-3">
                <label for="exampleInputEmail1">St rec estudio 5</label>
                <input type="name" class="form-control" name="str5" id="str5"   placeholder="..." required>
              </div>

              <div class=" col-3">
                <label for="exampleInputEmail1">St rec estudio 6</label>
                <input type="name" class="form-control" name="str6" id="str6"   placeholder="..." required>
              </div>
              ...
              <div class="form-row col-12 ">
                ...
                <div class="col-3">
                <label for="exampleInputEmail1">St rec estudio 7</label>
                <input type="name" class="form-control" name="str7" id="str7"   placeholder="..." required>
                </div>                
              <div class=" col-3">
                <label for="exampleInputPassword1">St rec estudio 8</label>
                <input type="name" class="form-control"  name="str8" id="str8"  placeholder="..." required>
                </div>
                <div class=" col-3">
                <label for="exampleInputEmail1">St rec estudio 9</label>
                <input type="name" class="form-control" name="str9" id="str9"   placeholder="..." required>
              </div>

              <div class=" col-3">
                <label for="exampleInputEmail1">St rec estudio 10</label>
                <input type="name" class="form-control" name="str10" id="str10"   placeholder="..." required>
              </div>
