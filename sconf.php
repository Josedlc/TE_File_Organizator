...
<section class="container-fluid ">
    ...
    <section class="row justify-content-center"> 
        ...
        <form action="iconf.php" class="form-container" method= "post" align="center" enctype="multipart/form-data">
    ...
    <option value="1">Prueba electrica</option>
    <option value="2">Sistema de vision</option>
    <option value="3">Fixtura</option>
                ...
                <div class="col-3">
                  ...
                  <input type="name" class="form-control" name="fecha" id="fecha"   placeholder="..." required>
                </div>
                <div class="col-3">
