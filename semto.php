...
<section class="container-fluid ">
    ...
    <section class="row justify-content-center"> 
        ...
        <form action="iemto.php" class="form-container" method= "post" align="center" enctype="multipart/form-data">
    ...
    <option value="1">Crimpeado</option>
    <option value="2">SuperCEP</option>
    <option value="3">MSA</option>
    <option value="4">RFs</option>
    </select>
             </div>  
              <div class="col-3">
                ...
                <div class="form-row col-12 ">
                  ...
                  <input type="name" class="form-control" name="testudio" id="testudio"   placeholder="..." required>
                </div>
                <div class="col-3">
                  <label for="exampleInputEmail1">Quien requiere</label>
                ...
                <div class=" col-3">
                  <label for="exampleInputPassword1">Ing. manufactura</label>
                ...
                <div class="form-row col-12 py-3">
                 ...
                 <div class="col-3">
                  <label for="exampleInputEmail1">Fase de entrenamiento</label>
                  <input type="name" class="form-control" name="femto" id="femto"   placeholder="..." required>
                  </div>
                   <div class="col-3">
                  <label for="exampleInputEmail1">Resultado</label>
                  <input type="name" class="form-control" name="result" id="result"   placeholder="..." required>
                  </div> 
                  <div class=" col-3">
                ...
                <div class=" col-3">
                  <label for="exampleInputPassword1">Entrenador</label>
                  <input type="name" class="form-control"  name="entrenador" id="entrenador"  placeholder="..." required>
                  </div>
                </div>
               
                <div class="form-row col-12 ">
                <div class=" col-3">
                  <label for="exampleInputEmail1">Depto entrenador</label>
                  <input type="name" class="form-control" name="depto" id="depto"   placeholder="..." required>
                </div>

                <div class=" col-3">
                  <label for="exampleInputEmail1">Operador</label>
                  <input type="name" class="form-control" name="op" id="op"   placeholder="..." required>
                </div>
                 
                  <div class=" col-3">
                  <label for="exampleInputEmail1">Depto operador</label>
                  <input type="name" class="form-control" name="deptop" id="detop"   placeholder="..." required>
                </div>

                <div class=" col-3">
                  <label for="exampleInputEmail1">Piezas patrones</label>
                  <input type="name" class="form-control" name="piezas" id="piezas"   placeholder="..." required>
                </div>
