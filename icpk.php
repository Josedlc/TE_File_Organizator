...
if($_FILES['archivo']["error"] > 0){
    ...
    switch($mystipo){
        case 1:
        move_uploaded_file($_FILES['archivo']['tmp_name'], 'CPK/125/'.$_FILES['archivo']['name']);
        $loc='CPK/125/'.$_FILES['archivo']['name'];
        break;
        case 2:
        move_uploaded_file($_FILES['archivo']['tmp_name'], 'CPK/30/'.$_FILES['archivo']['name']);
        $loc='CPK/30/'.$_FILES['archivo']['name'];
        break;

        case 3:
        move_uploaded_file($_FILES['archivo']['tmp_name'], 'CPK/C30/'.$_FILES['archivo']['name']);
        $loc='CPK/C30/'.$_FILES['archivo']['name'];
        break;
