...
if($_FILES['archivo']["error"] > 0){
    ...
    switch($mystipo){
        case 1:
        move_uploaded_file($_FILES['archivo']['tmp_name'], 'Confiabilidad/Prueba electrica/'.$_FILES['archivo']['name']);
        $loc='Confiabilidad/Prueba electrica/'.$_FILES['archivo']['name'];
        break;
        case 2:
        move_uploaded_file($_FILES['archivo']['tmp_name'], 'Confiabilidad/Sistema de vision/'.$_FILES['archivo']['name']);
        $loc='Confiabilidad/Sistema de vision/'.$_FILES['archivo']['name'];
        break;

        case 3:
        move_uploaded_file($_FILES['archivo']['tmp_name'], 'Confiabilidad/Fixtura/'.$_FILES['archivo']['name']);
        $loc='Confiabilidad/Fixtura/'.$_FILES['archivo']['name'];
        break;
